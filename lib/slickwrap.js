...
export default {
  ...
  adjustText(text, cursorIndex, limit) {
    ...
    var nextPiece = text.substring(newlineIndex + 1);
    var nextResult = adjustText(nextPiece, cursorIndex - newlineIndex, limit);

    var adjustResult = adjustText(nextPiece, ???, limit);
    var resultPiece = curPiece + adjustResult.text;
